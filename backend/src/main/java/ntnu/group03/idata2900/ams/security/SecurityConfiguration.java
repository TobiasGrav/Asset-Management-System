    ...
    public SecurityFilterChain configureAuthorizationFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/comments/**").hasAnyAuthority(SecurityAccessUtil.ADMIN, SecurityAccessUtil.TECHNICIAN)
                        .requestMatchers("/api/servicesCompleted/**").hasAnyAuthority(SecurityAccessUtil.ADMIN, SecurityAccessUtil.USER)
